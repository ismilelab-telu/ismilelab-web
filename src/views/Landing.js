  ...
  return (
    <nav className="navbar-landing">
      ...
      <div className="navbar-content">
        <a className="button about-us" href="#about-lab">
          About Lab
        </a>
  ...
  return (
    <section className="main">
      <div className="content">
        ...
        <p>
          Website untuk Praktikum mahasiswa Teknik Komputer Telkom University
        </p>
        <div className="button-wrapper">
          ...
          <a
            ...
            href="https://www.instagram.com/ismilelabs/"
            target="_blank"
          >
            <svg
          ...
          <a
            className="icon line"
            href="https://liff.line.me/1645278921-kWRPP32q/?accountId=qup6728v"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <img
        ...
        src={gradientVector}
        height={"100%"}
        alt="Gredient Element"
      />
      <img
        className="background-gradient-mini"
        src={gradientVector}
        height={"100%"}
        alt="Gredient Element"
      />
  ...
  return (
    <div className="about" id="about-lab">
      ...
      <div className="info-content">
        <h1>About Us</h1>
        <p>
          i-Smile (Intelligent System and Machine Learning) Laboratory merupakan
          bagian dari Laboratorium RAID (Realm of Artificial Intelligence
          Design) yang berfokus pada pengembangan Kecerdasan Buatan (Artificial
          Intelligence).
        </p>
        <img className="eyes" src={eyes3D} alt="" />
      </div>
    </div>
  );
}
  ...
  return (
    <footer className="footer-landing">
      <div className="wrapper">
        <h3>Address</h3>
        <p>
          Gedung TULT 1413 Lantai 14, Jl. Telekomunikasi Terusan Buah Batu,
          Bandung-40257, Indonesia
        </p>
        <p>Email: ismilelab@365.telkomuniversity.ac.id</p>
